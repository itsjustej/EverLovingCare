...
function App() {
  ...
  const renderNavigation = () => (
    <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm shadow-lg z-50 transition-all duration-300 border-b border-yellow-500/20">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-2xl font-serif text-yellow-600 italic font-bold">Ever Loving Care</span>
              <span className="text-xs text-gray-600 tracking-wider uppercase">Home Away From Home</span>
            </div>
          </button>
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-300 ${
                  currentPage === id
                    ? 'bg-yellow-500/20 text-yellow-700 shadow-lg border border-yellow-500/30'
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            {[
              ...
              <button
                key={id}
                onClick={() => navigateToPage(id)}
                className="flex items-center space-x-3 w-full px-4 py-3 text-left text-gray-700 hover:bg-gray-100 hover:text-yellow-600 transition-colors"
              >
  ...
  const renderHomePage = () => (
    <div className="pt-20 bg-gray-50">
      ...
      <div className="relative md:h-[400px] overflow-hidden">
        ...
        <button
          onClick={prevImage}
          className="absolute left-4 top-1/2 transform -translate-y-1/2 z-20 bg-white/80 backdrop-blur-sm text-yellow-600 p-3 rounded-full hover:bg-white transition-all duration-300 border border-yellow-500/30 shadow-lg"
        >
          <ChevronLeft className="h-6 w-6" />
        </button>
        <button
          onClick={nextImage}
          className="absolute right-4 top-1/2 transform -translate-y-1/2 z-20 bg-white/80 backdrop-blur-sm text-yellow-600 p-3 rounded-full hover:bg-white transition-all duration-300 border border-yellow-500/30 shadow-lg"
        >
          ...
          {carouselImages.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 ${
                index === currentImageIndex ? 'bg-yellow-500' : 'bg-white/70'
              }`}
            />
          ))}
        </div>
      ...
      <div className="text-center mb-2 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <h2 className="text-4xl font-bold text-gray-800 pt-10 mb-6">About Our Community</h2>
        <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
          Ever Loving Care is located in <span className="text-yellow-600 font-medium">Nolen Farm</span>,
          a peaceful new home community nestled in the South Gastonia and Belmont area.
          Our residents enjoy <span className="text-yellow-600 font-medium">resort-style amenities</span> including a clubhouse with pool,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gray-50">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Mission */}
          <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border border-gray-200">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border border-gray-200">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800 ml-4">Our Philosophy</h3>
            </div>
            <div className="text-gray-700 leading-relaxed">
              <ul className="list-disc list-inside space-y-2">
    ...
    <div className="pt-20 py-16 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-4 pt-10">Our Services</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              description: "Engaging recreational opportunities for residents to engage in community, cultural, employment, recreational, spiritual, and social events based on their interests/plan."
            },
            {
              icon: Phone,
  ...
  const renderEmploymentPage = () => (
    <div className="pt-20 py-16 bg-gray-50 min-h-screen">
      <div className="text-center mb-16 px-4">
        <h2 className="text-4xl font-bold text-gray-800 mb-4 pt-10">Join Our Team</h2>
        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
      ...
      <div className="w-full px-4 lg:px-32">
        <div className="bg-white rounded-2xl shadow-xl p-10 border border-gray-200 text-center">
          ...
          <div className="space-y-4 text-gray-700 text-left max-w-4xl mx-auto">
            <p className="leading-relaxed">
              <strong className="text-yellow-600">Residential Care Assistant</strong> - Join our compassionate team providing direct care to residents in a warm, family-like environment. This full-time position offers competitive compensation, comprehensive benefits, and opportunities for professional growth.
            </p>
            <p className="leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-10">
              ...
              <div className="bg-gray-100 rounded-lg p-6 border border-gray-300 text-center">
                <h3 className="text-3xl font-bold mb-4 text-yellow-600">Accreditation Now</h3>
                <a
                  href="https://www.accreditationnow.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg"
                >
                  <span>Begin Training</span>
                  <ExternalLink className="h-5 w-5 ml-2" />
                </a>
                <p className="text-sm text-gray-600 mt-5">
                  Completion time: <span className="font-medium text-gray-800">15 Minutes</span>
                </p>
              </div>

              {/* Canvas Link Box */}
              <div className="bg-gray-100 rounded-lg p-6 border border-gray-300 text-center">
                <h3 className="text-3xl font-bold mb-4 text-yellow-600">Onboarding</h3>
                <a
                ...
                <p className="text-sm text-gray-600 mt-5">
                  Completion time: <span className="font-medium text-gray-800">8-10 Hours</span>
                </p>
              </div>
            </div>
          </div>
  ...
  const renderContactPage = () => (
    <div className="pt-20 py-16 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-4 pt-10">Contact Us</h2>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors text-gray-800 placeholder-gray-500"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Reason for Contact *</label>
              <div className="grid md:grid-cols-3 gap-4">
                {[
                  ...
                  <label key={option.value} className="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-300 hover:border-yellow-500/50 transition-colors cursor-pointer">
                    <input
                      type="radio"
                      name="reason"
                      value={option.value}
                      ...
                      className="h-4 w-4 text-yellow-500 focus:ring-yellow-500 border-gray-400"
                    />
                    <span className="ml-3 text-gray-700 text-sm font-medium">{option.label}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="text-center">
              <button
                type="submit"
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white py-4 px-12 rounded-lg font-semibold hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 shadow-lg hover:shadow-xl text-lg"
              >
                Send Message
              </button>
            </div>
  ...
  const renderFooter = () => (
    <footer className="bg-gray-800 text-white py-12 border-t border-gray-300">
